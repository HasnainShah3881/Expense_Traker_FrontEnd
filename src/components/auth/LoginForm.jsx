...
const LoginForm = ({ onChange }) => {
  ...
  return (
   <section className="flex flex-col justify-center items-center min-h-screen w-full px-2 sm:px-6 lg:px-8 font-sans bg-gray-50">
  <Toaster position="top-center" reverseOrder={false} />
  <div className="w-full max-w-xl rounded-xl p-3 sm:p-8">
    ...
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
      ...
      <button
        type="submit"
        disabled={loading}
        className="w-full bg-[#6757ac] cursor-pointer hover:bg-[#5d49b6] text-white font-semibold py-3 rounded-md transition duration-200 disabled:opacity-70"
      >
